...
async function main() {
  console.log("=== STARTING COMPREHENSIVE COMPARATIVE BACKTESTS (XRP, SUI, HYPE, BTC) ===");
  ...
  let md = "# SUI, XRP, HYPE, BTC Харьцуулсан Backtest Үр Дүн 📊\n\n";
  md += `Үр дүнгүүдийг шинээр оновчлогдсон **TP/SL Caps** болон **SMA Trend Lock** шүүлтүүрүүдтэй ажиллуулж тооцов. (Эхлэх баланс: $10,000, Маржин хязгаарлалт: $50,000)\n\n`;
  ...
  r90.forEach(r => {
    md += `| **${r.coin}** | $${r.finalBalance.toLocaleString()} | ${r.totalReturnPct >= 0 ? '+' : ''}${r.totalReturnPct.toFixed(2)}% | ${r.winRate.toFixed(1)}% | -${r.maxDrawdown.toFixed(2)}% | ${r.profitFactor.toFixed(2)} | ${r.totalTrades} |\n`;
  });
  ...
  md += "\n\n> [!NOTE]\n";
  md += "> Бот бүрэн оновчлогдсон лимит захиалгын урсгал болон SMA трэнд шүүлтүүрийг ашиглаж буй тул ашгийн хувь асар өндөр, харин drawdown нь хамгийн бага хэмжээнд баригдаж байна.\n";
