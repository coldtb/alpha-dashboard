...
const xrpPath = 'C:/Users/hitech/.gemini/antigravity/brain/8ed4ba99-216e-4ac1-bddc-40059445a636/scratch/xrp_real_debug.json';

if (!fs.existsSync(xrpPath)) {
  console.log("XRP backtest debug file not found.");
  process.exit(1);
}

const data = JSON.parse(fs.readFileSync(xrpPath, 'utf8'));
...
console.log("=== XRP DIRECTIONAL P&L ANALYSIS ===");
